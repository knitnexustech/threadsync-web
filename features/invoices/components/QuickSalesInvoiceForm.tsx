...
export const QuickSalesInvoiceForm: React.FC<QuickSalesInvoiceFormProps> = ({ currentUser, initialData, onClose }) => {
    ...
    const [selectedBuyer, setSelectedBuyer]   = useState<{ id: string, type: 'partner' | 'contact', name: string } | null>(
        initialData ? {
    ...
    const handleCreate = async () => {
        ...
        try {
            const invoiceData = {
                ...
                buyer_company_id:  selectedBuyer.type === 'partner' ? selectedBuyer.id : undefined,
