                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                                ...
                                {files.map(file => (
                                    <div key={file.id} className="flex items-center p-3 border border-gray-200 rounded-lg hover:border-blue-300 transition-all group relative bg-white shadow-sm">
                                        ...
                                        {/* Delete Action - Positioned to the right - RESTRICTED */}
                                        {canEditChannel && (
                                            <button
                                                onClick={(e) => {
                                                ...
                                                className="p-2 ml-2 text-gray-300 hover:text-red-500 hover:bg-red-50 rounded-full transition-colors focus:outline-none z-10"
                                                title="Remove File"
                                            >
